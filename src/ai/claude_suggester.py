"""
Claude AI Color Suggester
Alternative AI suggester using Anthropic's Claude API
(Può essere più potente di Gemini ma è a pagamento)
"""
...
class ClaudeColorSuggester:
    """AI-powered color suggestion using Claude"""
    ...
    def suggest_colors(self, song_info, metadata=None, audio_features=None):
        ...
        try:
            ...
            print(f"🎨 Asking Claude for color suggestions...")
            ...
            if result:
                print(f"✅ Claude suggested palette: {result['palette']}")
...
**Task:**
Suggest an RGB lighting scheme that matches the song's mood, theme, and energy. Be creative and thoughtful about the emotional impact of colors.
...
4. Explain your reasoning briefly (max 50 words)
